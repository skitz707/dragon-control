	...
	public function printAdminEnemyCard() {
		echo '
			<div class="adminPlayerCard">
				...
				Initiative: ' . number_format($this->initiative, 0, "", "") . '
				<div class="blueButton" onClick="setInit(\'enemy\', ' . $this->enemyId . ');">Set Init</div> <div class="redButton" onClick="takeDamage(\'enemy\', ' . $this->enemyId . ');">Take Damage</div> <div class="greenButton" onClick="heal(\'enemy\', ' . $this->enemyId . ');">Heal</div>
			</div>
		';
	}
	//------------------------------------------------------------------------
